...
class PostBoardDB extends React.Component {
    ...
    handleReload = () => {
        fetch('http://192.168.1.221:8080/api/getPosts', {method: 'POST'})
            .then(res => res.json())
    ...
    handleRemove = (id, p_id) => {
        ...
        fetch('http://192.168.1.221:8080/api/delPost', request)
            .then(res => res.json())
            .then(data => this.setState({
                posts: data
            }));
    ...
    handleAdd = () => {
        ...
        fetch('http://192.168.1.221:8080/api/addPost', request)
            .then(res => res.json())
            .then(data => this.setState({
                posts: data,
                title: '',
